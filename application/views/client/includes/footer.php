<footer id="footer" class="footer ">
    ...
    <div class="container">
        <?php if (isset($footer)) {
            foreach ($footer->result() as $row) { ?>
                <div class="desktop-gyanContainer" data-reactid="348" style='font-size:14px;'>
                    <p><?php echo $row->footer_content; ?></p>
                </div>
            <?php }
        } else { ?>
            <h2><strong style="color:white;">ONLINE SHOPPING ON MYNTRA</strong></h2>
            <ul>
            ...
            <h3><strong style='color:white;'>AFFORDABLE FASHION AT YOUR FINGERTIPS</strong></h3>
            ...
            <h3><strong style='color:white;'>MYNTRA INSIDER</strong></h3>
            ...
            <h3><strong style='color:white;'>Myntra Studio - The Personalised Fashion Feed You Wouldn’t Want To Miss Out On</strong></h3>
            ...
            <p>Myntra is one such online shopping website that joins the list of platforms that help curate a personalised fashion feed. Named the<a class="seolink" href="/studio/home">Myntra Studio</a>, this personalised search feed brings you the latest men and women’s fashion trends, celebrity styles, branded content and daily updates from your favourite fashion labels.</p>
            ...
            <h3><strong style='color:white;'>MYNTRA APP</strong></h3>
            ...
            <h3><strong style='color:white;'>HISTORY OF MYNTRA</strong></h3>
            ...
            <h3><strong style='color:white;'>SHOP ONLINE AT MYNTRA WITH COMPLETE CONVENIENCE</strong></h3>
    ...
    <div class="reserved">
        <div class="container">
            <span class="caption">© 2021 <a href="/">Spaline.com</a> All rights reserved.</span>
