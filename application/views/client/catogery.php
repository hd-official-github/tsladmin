    ...
    <?php foreach($sub_cat->result() as $row) { ?>
        <div class='secondary_navbar mx-5 animated bounceInUp'>
            ...
            <div class='secondary-icon'>
                <a href="detail" class='text-decorate'>
                    <img src="<?php echo base_url() . 'assets/images/fullbody.png'; ?>" alt="icon" class='image-icon'>
                    <p class='pag' style='text-align:center;'> Ayurvedic spa </p>
                </a>
        ...
        <div class='secondary_navbar mx-5 animated bounceInUp'>
            ...
            <div class='secondary-icon'>
                <a href="" class='text-decorate'>
                    <img src="<?php echo base_url() . 'assets/images/fullbody.png'; ?>" alt="icon" class='image-icon'>
                    <p class='pag' style='text-align:center;'> Fully body spa </p>
                </a>
        ...
        <div class='secondary_navbar mx-5 animated bounceInUp'>
            ...
            <div class='secondary-icon'>
                <a href="" class='text-decorate'>
                    <img src="<?php echo base_url() . 'assets/images/fullbody.png'; ?>" alt="icon" class='image-icon'>
                    <p class='pag' style='text-align:center;'> Arome home spa</p>
                </a>
