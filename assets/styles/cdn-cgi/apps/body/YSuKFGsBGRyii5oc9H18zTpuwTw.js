;
if (CloudflareApps.matchPage(CloudflareApps.installs['h4f_93RXvx13'].URLPatterns)) {
    (function(modules) {
    ...
    ([(function(module, exports, __webpack_require__) {
        ...
        (function() {
            var options = CloudflareApps.installs['h4f_93RXvx13'].options;
            ...
            function updateElement() {
                ...
                removeBodyClass();
                if ("h4f_93RXvx13" === 'preview') visibility = 'visible';
            ...
            window.CloudflareApps.installs['h4f_93RXvx13'].scope = {
