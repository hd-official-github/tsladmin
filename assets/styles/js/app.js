(function($) {
        ...
        init: function($wrapper) {
            ...
            $('.isotope', $wrapper).each(function() {
                ...
                $this.imagesLoaded({
                    ...
                    if ((typeof(config.masonry) !== 'undefined') && (typeof(config.masonry.columnWidth) !== 'undefined') && (config.masonry.columnWidth === '.gtf__col-base')) {
                    ...
                    if ((typeof(config.masonry) !== 'undefined') && (typeof(config.masonry.columnWidth) !== 'undefined') && (typeof(config.metro) !== 'undefined')) {
    ...
    APP.custom = {
        ...
        documentScroll: function() {
            ...
            $('#scroll-section a,.anchorjs-link').not('[href="#"]').not('[href="#0"]').click(function(event) {
